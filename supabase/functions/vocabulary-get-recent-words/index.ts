/**
 * Supabase Edge Function: Get Recent Words
 * Returns recently learned words for a book
 */
...
interface GetRecentWordsRequest {
  bookId: string
  limit?: number
}
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const input: GetRecentWordsRequest = await req.json()
